            ...
            lines.append(
                ...
                + " | ".join(
                    [
                        ...
                        format_count(item.get("runtimeFontSubstitutions")),
                        format_count(item.get("runtimeUnregisteredFontFallbacks")),
