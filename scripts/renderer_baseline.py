            ...
            browser_performance_summary.append(
                {
                    ...
                    / sample_count,
                    "averageSelectedPageRenderMs": summary["selectedPageRenderMsTotal"]
                    / sample_count,
    ...
    if browser_data and browser_data.get("results"):
        lines.extend(
            [
                ...
                "## Browser Performance",
                "",
                "| Sample | Backend | Profile | Page | App Load ms | Document Load + Initial Render ms | Selected Page Render ms | Screenshot ms | Total ms | Effect Pixels | Effect Cache Hits | Effect Cache Misses | Effect Failures |",
                "| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |",
            ]
        )
        for item in browser_data["results"]:
    ...
    if replay_summary_rows:
        lines.extend(
            [
                ...
                "",
                "| Backend | Profile | Captures | Items | Direct | Direct Required | Text Fallback | Unsupported | Compat Overlay | Hidden Overlay Violations | Runtime Image Failures | Runtime Text Failures | Pattern Surface Failures | Runtime Duplicate Reports | Runtime Selection Conflicts | v2 Issues |",
                "| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |",
            ]
        )
        ...
        lines.extend(
            [
                ...
                "",
                "| Backend | Profile | Plan Statuses | Plan Reasons | Runtime Selected Reasons | Runtime Rejected Reasons | Runtime Image Failures | Runtime Text Failures | v2 Issue Codes |",
                "| --- | --- | --- | --- | --- | --- | --- | --- | --- |",
            ]
        )
        for item in replay_summary_rows:
