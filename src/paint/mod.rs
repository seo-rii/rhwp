...
pub use text_v2::{
    ...
    strict_glyph_outline_text_v2_slots, text_v2_validation_issues_to_json, validate_text_v2_op,
    validate_text_v2_ops, LayerTextPaintOpV2, LayerTextVariantPart, LayerTextVariantPayload,
    LayerTextVariantSet, PaintOrderSlotId, PaintScopeId, TextFallbackPolicy, TextV2ValidationIssue,
